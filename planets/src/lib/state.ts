...
const state = proxy<State>({
  ...
  ...((value) => (value ? JSON.parse(value) || {} : {}))(localStorage.getItem('planets')),
});

subscribe(state, () => localStorage.setItem('planets', JSON.stringify({ files: state.files, points: state.points })));
